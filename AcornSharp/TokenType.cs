...
namespace AcornSharp
{
    ...
    internal sealed class TokenType
    {
        ...
        public TokenType(string label, [CanBeNull] string keyword = null, bool beforeExpression = false, bool startsExpression = false, bool isLoop = false, bool isAssign = false, bool prefix = false, bool postfix = false, int binaryOperator = -1, [CanBeNull] Action<Parser, TokenType> updateContext = null)
        {
            Label = label;
            Keyword = keyword;
